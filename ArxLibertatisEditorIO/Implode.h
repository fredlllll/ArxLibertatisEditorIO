...
extern "C" {
	__declspec(dllexport) void __cdecl ArxIO_pack_alloc(const char* in, size_t inSize, char** out, size_t * outSize);
	__declspec(dllexport) void __cdecl ArxIO_pack_free(char* buffer);
}
